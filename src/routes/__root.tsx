...
export const Route = createRootRoute({
  ...
  ssr: true,
  head: () => {
    // The share card is a static PNG per language (public/og-{fr,en}.png,
    // regenerated by scripts/gen-og.ts): nothing about it varies per request,
    // so there is nothing to render on demand. Same absolute-URL dance as the
    // profile route — og:image must be absolute, and head() runs server-side
    // for the crawler (where BETTER_AUTH_URL is the public origin) and again on
    // the client for SPA navigation (where process.env compiles to {}).
    ...
    const description = m.og_description();
    ...
    return {
      ...
      meta: [
        ...
        { property: "og:image:alt", content: m.og_tagline() },
